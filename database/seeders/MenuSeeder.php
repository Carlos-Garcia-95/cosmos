    ...
    public function run(): void
    {
        ...
        DB::table('menus')->insert([
            [
                ...
                'precio' => 12.99,
                'imagen_url' => '/images/menus/nebulosa-burger.jpeg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'precio' => 8.50,
                'imagen_url' => '/images/menus/estrella-nachos.jpeg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'precio' => 9.75,
                'imagen_url' => '/images/menus/orbitron-dog.jpeg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'precio' => 4.00,
                'imagen_url' => '/images/menus/agujero-negro-bebida.jpeg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'precio' => 6.25,
                'imagen_url' => '/images/menus/supernova-popcorn.jpeg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'precio' => 5.50,
                'imagen_url' => '/images/menus/via-lactea-shake.jpeg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
